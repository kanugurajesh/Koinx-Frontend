        ...
        <div className="flex md:hidden items-center gap-2">
          ...
          >
            <div className="w-6 h-4 relative">
              <span
                className={`absolute h-0.5 w-6 bg-black dark:bg-white transform transition-all duration-300 ${
                  isMenuOpen ? "rotate-45 translate-y-1.5" : "translate-y-0"
                }`}
              ></span>
              <span
                className={`absolute h-0.5 w-6 bg-black dark:bg-white translate-y-1.5 transition-opacity duration-300 ${
